...
const links = [
    { label: 'Patients', link: '/demo/patients', color: 'fr-yellow.4' },
    { label: 'Appointments', link: '/demo/appointments', color: 'fr-pink' },
    { label: 'Calendar', link: '/demo/calendar', color: 'fr-cyan.4' },
    { label: 'Accounting', link: '/demo/accounting', color: 'teal' },
];
            ...
            <Header height={rem(60)} sx={{ borderBottom: 0 }} mb={10}>
                <Container className={classes.inner} fluid>
                    <Group>
                        ...
                        <UnstyledButton onClick={() => goToLink('/demo')} className={classes.link}>
                            <Group>
